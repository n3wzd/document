...
bool game() {
    ...
    for (int y = 0; y < N; y++) {
        for (int x = 0; x < N; x++) {
            ...
            if (group.size > maxGroup.size && group.size >= 2)<br>
                maxGroup = group;
            else if (group.size == maxGroup.size) {
                if (group.rainbow > maxGroup.rainbow)<br>
                    maxGroup = group;
                else if (group.rainbow == maxGroup.rainbow) {
                    if (group.y > maxGroup.y || (group.y == maxGroup.y && group.x > maxGroup.x))<br>
                        maxGroup = group;
                }
            }
        }
    }
    if (maxGroup.size > 0) {<br>
