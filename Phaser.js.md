...
## 객체
### Phaser.Container
- 여러 게임 객체들을 하나의 그룹으로 묶는 객체입니다.

### Phaser.Geom
- 좌표 계산, 충돌 검사, 도형의 크기와 위치 파악 등을 수행하는 객체입니다.
...
- 텍스처의 이름은 유일해야 합니다. 즉, 동일한 이름을 가진 텍스처가 이미 존재하면 새로운 텍스처를 추가할 때 기존 텍스처가 덮어씌워지게 됩니다.
- 생성한 텍스처를 변수로 저장하여 재사용할 수 있습니다.
